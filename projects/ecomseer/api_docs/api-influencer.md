...
```
GET /api/influencer/commerce-rank
```
...
```
GET /api/influencer/detail/chart
```
...
```
GET /api/influencer/detail/fans-portrait
```
...
```
GET /api/influencer/detail/videos
```
...
```
GET /api/influencer/detail/goods
```
...
```
GET /api/influencer/detail/live
```
...
```
GET /api/influencer/detail/category-list
```
...
```
GET /api/influencer/detail/active-range
```
...
```
GET /api/influencer/detail/similarity
```
...
```
GET /api/influencer/detail/fans-analysis
```
...
```
GET /api/influencer/detail/cargo-summary
```
...
```
GET /api/influencer/detail/labels
```
